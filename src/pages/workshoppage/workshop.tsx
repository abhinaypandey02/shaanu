  ...
  return (
    <div className="container-fluid m-0 p-0">
      ...
      >
        ...
        <Modal.Body>ENTER CAROUSEL HERE</Modal.Body>
      </Modal>
      ...
      <div className="container-fluid py-5" id="section3">
        ...
        <Carousel fade>
          <Carousel.Item>
            <div
              className="card mx-auto text-light border-light rounded-3 p-3 bg-warning"
              style={{ maxWidth: 1000 }}
            >
          ...
          <Carousel.Item>
            <div
              className="card mx-auto text-light border-light p-3"
              style={{ maxWidth: 1000 }}
            >
              <div className="row d-flex justify-content-center">
                <div className="col-md-2 my-auto">
          ...
          <Carousel.Item>
            ...
            >
              <div className="row d-flex justify-content-center">
                <div className="col-md-2 my-auto">
                  <img
                    src="https://images.unsplash.com/photo-1481114070102-72f9d11057dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1104&q=80"
                    className="img-fluid border rounded-circle"
                    alt="..."
                  />
                </div>
              ...
              <Card className=" p-0 m-0">
                <Card.Header className="bg-dark text-warning  p-0 m-0">
                  <Accordion.Toggle as={Card.Header} eventKey="2">
                    ...
                    typesetdddddddddddddddddddddddddddasdsadadting industry ?
                  </Accordion.Toggle>
                </Card.Header>
                <Accordion.Collapse
                  className="border border-warning"
