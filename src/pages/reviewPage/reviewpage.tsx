...
export default function ReviewPage(){
    ...
    const [sortBy,setSortBy]=useState<"RATING_ASC"|"RATING_DSC">("RATING_ASC");
        ...
        <div className="container">
                            ...
                            <div className="col-md-8 d-flex justify-content-start">
                                <div>
                                    {[1,2,3,4,5].map(number=>
                                        <span className="pointer-on-hover" onClick={()=>setRating(number)}>
                                            <img height={30} src={rating>=number?filledStar:emptyStar} alt="star"/>
                                        </span>
            ...
            <div className="container">
                ...
                <Dropdown>
                    ...
                    <Dropdown.Menu>
                        <Dropdown.Item onClick={()=>setSortBy("RATING_DSC")}>Highest</Dropdown.Item>
                        <Dropdown.Item onClick={()=>setSortBy("RATING_ASC")}>Lowest</Dropdown.Item>
                    </Dropdown.Menu>
                </Dropdown>
                </div>
                {REVIEWS.map(review=><div className="row">
                    <div className="card border border-warning rounded-0 mx-auto text-light rounded-0 p-3" style={{ maxWidth: 1000 }} >
                        <div className="row d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div className="row d-flex align-items-center justify-content-center flex-column mx-auto">
                                ...
                                <img src={review.image} className='img-fluid border w-25 bg-light rounded-circle' alt="..." />
                                <br/>
                            ...
                            <div className="my-3">
                                {[1,2,3,4,5].map(number=>
                                    <span>
                                            <img height={30} src={review.rating>=number?filledStar:emptyStar} alt="star"/>
                                        </span>
