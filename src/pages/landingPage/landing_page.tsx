  ...
  return (
    <div>
      ...
      >
        <Modal.Header
          closeButton
          className="bg-warning rounded-0 overflow-auto"
        >
          ...
          <div className="row text-light py-5">
            <div className="col-md-3 text-center">
              <p className="font-weight-bold display-3 mt-3">
                <CountUp start={0} end={23} duration={5} redraw={true}>
                  {({ countUpRef, start }) => (
            ...
            <div className="col-md-3 text-center">
              <p className="font-weight-bold display-3 mt-3">
                <CountUp start={0} end={1243} duration={5} redraw={true}>
                  {({ countUpRef, start }) => (
                    <VisibilitySensor onChange={start} delayedCall>
                      <span ref={countUpRef} />
                    </VisibilitySensor>
            ...
            <div className="col-md-3 text-center">
              <p className="font-weight-bold display-3 mt-3">
                <CountUp start={0} end={970} duration={5} redraw={true}>
                  {({ countUpRef, start }) => (
                    <VisibilitySensor onChange={start} delayedCall>
                      <span ref={countUpRef} />
                    </VisibilitySensor>
