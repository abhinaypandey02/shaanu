                    ...
                    <Accordion.Collapse eventKey={category}>
                        <Card.Body className="border border-warning">
                            {docs.map((doc) => (
                                <div
                                    key={doc.name}
                                    className="my-2 py-2 px-3 flex-wrap d-flex align-items-center justify-content-between w-100 text-light border rounded border-warning"
                                >
                                    ...
                                    {doc.url !== "null" ? (
                                        <div>
                                            <Button
                                                ...
                                                className="rounded-circle m-1 p-1"
                                                variant="danger"
                                            >
                                                <img
                                                    src="https://img.icons8.com/material-rounded/24/000000/delete-forever.png" />
                                            </Button>
                                            <Button className="rounded-circle m-1 p-1"
                                                    variant="warning" onClick={() => renameFile(doc.id, doc.name)}>
                                                <img
